document.addEventListener("DOMContentLoaded", () => {
  ...
  // added funct to the js for the button :
  ...
  const questions = [
    new Question("Wich of these is NOT a valid HTML tagg ?", ["<div>", "<span>", "<section>", "<bold>"], "<bold>", 1),
    new Question("What does console.log([ ] == false) output?", ["true", "false", "undefined", "It throws an error"], "true", 1),
    ...
    new Question("During the Ironhack program, students receive a welcome goodies pack.Which item is most likely included?", ["A paid ChatGPT-GO yearly subscription", "A fully configured MacBook Pro", "A Costum mechanical keyboar and mousepad", "A branded hoodie"], "A branded hoodie", 3),
  ...
  /************  EVENT LISTENERS  ************/
  /*confusing logic for the reset button just added a page reset ... kind works right ? */
